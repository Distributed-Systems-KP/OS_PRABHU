...
struct	pentry	{
	...
	int	pwaitret;
	// int epoch; /* This is the epoch at which the quantum of the process was calculated*/
	int counter; /*This is the remaining ticks available for the process in the current epoch*/
	int quantum; /* This is the total time slice allocated for the process*/
	int present_in_epoch; /*This is a flag that is used to check if the process was scheduled in the beginning of the current epoch*/
	int new_priority; /*If the priority is changed in between an epoch, this will ensure that the process has the current priority*/
};
